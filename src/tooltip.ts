                    ...
                    if (object.type === "curve") {
                        ...
                        let sequence = this.commons.stringSequence;
                         ...
                         if (elemHover?.x !== undefined && sequence[elemHover.x] !== undefined) {
                            ...
                            const type = elemHover.type 
                                ? `<p style="margin:2px;">Type: ${elemHover.type}</p>` 
                                : "";

                            return `${title}${score}${position}${type}`;
                            }
                        ...
                        if (pD.type){
                            return `
                                <p style="margin:2px;font-weight:700;">${pD.title}</p>
                                <p style="margin:2px;">Region: ${pD.x} - ${pD.y}</p>
                                <p style="margin:2px;">Position: ${exactPos}${sequence}</p>
                                <p style="margin:2px;">Type: ${pD.type}</p>
                            `;
                        }

                        // Default formatting for rectangles
                        return `
                            <p style="margin:2px;font-weight:700;">${pD.title || "Data"}</p>
                            <p style="margin:2px;">Region: ${pD.x} - ${pD.y}</p>
                            <p style="margin:2px;">Position: ${exactPos}${sequence}</p>
                        `;
